...
insert into sys_menu (id, title, name, path, sort, icon, type, component, perms, status, display, cache, link, remark, parent_id, created_time, updated_time)
values
(2147098509659213825, 'AI Chat', 'AIChat', '/plugins/ai/chat', 1, 'ri:chat-ai-line', 1, '/plugins/ai/views/chat', null, 1, 1, 1, '', null, 2147098509659213824, now(), null),
(2147098509659213826, '供应商管理', 'AIProviderManage', '/plugins/ai/provider', 2, 'mdi:hub-outline', 1, '/plugins/ai/views/provider', null, 1, 1, 1, '', null, 2147098509659213824, now(), null),
...
(2147098509659213830, '模型管理', 'AIModelManage', '/plugins/ai/model', 3, 'carbon:model-alt', 1, '/plugins/ai/views/model', null, 1, 1, 1, '', null, 2147098509659213824, now(), null),
...
(2147098509659213834, '快捷短语', 'AIQuickPhraseManage', '/plugins/ai/quick-phrase', 4, 'mdi:lightning-bolt-outline', 1, '/plugins/ai/views/quick-phrase', null, 1, 1, 1, '', null, 2147098509659213824, now(), null),
(2147098509659213835, 'MCP 管理', 'AIMcpManage', '/plugins/ai/mcp', 5, 'simple-icons:modelcontextprotocol', 1, '/plugins/ai/views/mcp', null, 1, 1, 1, '', null, 2147098509659213824, now(), null),
